...
public class ColorTrackView extends View {
	private static final String TAG = ColorTrackView.class.getName();
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mTextStartY = getMeasuredHeight()
				/ 2
				- (mPaint.getFontMetricsInt().bottom - mPaint
						.getFontMetricsInt().top) / 2
				- mPaint.getFontMetricsInt().top;
	}
